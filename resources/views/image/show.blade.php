    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="d-flex align-items-center mb-3">
          <img src="https://www.gravatar.com/avatar/c1d58af78e2086e8348f0f3b70425b25?d=mp&amp;s=60" alt="Author"
        ...
        <div class="d-flex justify-content-between py-3 border-top border-bottom">
          ...
          <div>
            <button type="button" title="Like mage" class="btn btn-primary">
              <x-icon iconSrc="thumbs-up.svg" alt="" class="align-text-top" width="18" height="18" /> 150
            </button>

            <button type="button" title="Favorite mage" class="btn btn-danger">
              <x-icon iconSrc="heart.svg" alt="" width="18" height="18" />
            </button>
          </div>

          <button title="Download" class="btn btn-success d-flex align-items-center">
            <x-icon iconSrc="download.svg" alt="" class="align-text-top" width="18" height="18" />
