...
<head>
  ...
  <title>{{ $title ? $title . ' | ' : '' }}Larapics</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-light border-bottom">
    <div class="container-fluid">
      <a class="navbar-brand" href="/">
        <x-icon iconSrc="logo.svg" alt="Photo" width="30" height="24"
        ...
        <ul class="navbar-nav ms-auto">
          ...
          @else
            ...
            <li class="nav-item"><a href="#"
                class="nav-link {{ request()->is('account/favorites*') ? 'active' : '' }}">Favorites</a></li>
            <li class="nav-item"><a href="{{ route('comments.index') }}"
                class="nav-link {{ request()->is('account/comments*') ? 'active' : '' }}">Comments</a></li>
