      ...
      <div class="row gx-5">
        <div class="col-md-6">
          <fieldset>
            ...
            <div class="mb-3">
              <img src="{{ $user->profileImageUrl() }}" width="150" alt="{{ $user->name }}">
            </div>
            <div class="mb-3">
          ...
          <fieldset>
            ...
            <div class="mb-3">
              ...
              <input type="file" name="user[cover_image]" id="cover_image"
                class="form-control  @error('user.cover_image') is-invalid @enderror"
            ...
            <div class="mb-3">
              @if ($user->hasCoverImage())
                <img src="{{ $user->coverImageUrl() }}" class="img-fluid" alt="{{ $user->name }}">
              @endif
            </div>
          </fieldset>
          <fieldset class="mt-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="social[website]" id="website"
                class="form-control @error('social.website') is-invalid @enderror" placeholder="https://..."
          ...
          <fieldset class="mt-3">
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="options[disable_comments]"
                    id="disable_comments_no" value="0" @if (old('options.disable_comments', $user->setting->disable_comments) == 0) checked @endif>
                  <label class="form-check-label" for="disable_comments_no">No</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="options[disable_comments]"
                    id="disable_comments_yes" value="1" @if (old('options.disable_comments', $user->setting->disable_comments) == 1) checked @endif>
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="options[moderate_comments]"
                    id="moderate_comments_no" value="0" @if (old('options.moderate_comments', $user->setting->moderate_comments) == 0) checked @endif>
                  <label class="form-check-label" for="moderate_comments_no">No</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="options[moderate_comments]"
                    id="moderate_comments_yes" value="1" @if (old('options.moderate_comments', $user->setting->moderate_comments) == 1) checked @endif>
            ...
            <div class="mb-3">
              ...
              <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="options[email_notification][new_comment]"
                  id="email_notification_no" value="1" @if (old('options.email_notification.new_comment', $user->setting->email_notification['new_comment']) == 1) checked @endif>
              ...
              <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="options[email_notification][new_image]"
                  id="email_notification_yes" value="1" @if (old('options.email_notification.new_image', $user->setting->email_notification['new_image']) == 1) checked @endif>
                <label class="form-check-label" for="disable_comments_new_image">
